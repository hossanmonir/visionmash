...
.single-post.header-transparent.minimalist-header-no:not(.single-template-intro) #Header{
	margin-bottom:<?php echo esc_attr($aLogo['top_bar_right_H']); ?>px;
}

.single-post.header-transparent.minimalist-header.ab-show:not(.single-template-intro) #Header,
.single-post.header-transparent.minimalist-header-no.ab-show:not(.single-template-intro) #Header{
	margin-bottom:<?php echo esc_attr($aLogo['top_bar_right_H'] + 60); ?>px;
}
